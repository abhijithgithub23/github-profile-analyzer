              ...
              <div key={user.login} className="bg-gray-900/50 backdrop-blur-md p-6 rounded-3xl border border-gray-800 text-center flex flex-col relative group hover:border-blue-500/30 transition duration-300">
                ...
                <div className="mt-auto flex gap-2 relative z-10">
                  <button 
                    ...
                    className="flex-1 bg-white/5 border border-white/10 text-white py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-white hover:text-gray-950 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition duration-300"
                  >
                    Analyze
                  </button>
                  <button 
                    onClick={() => dispatch(toggleStar(user))}
                    className="px-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl hover:bg-red-500 hover:text-white hover:shadow-[0_0_15px_rgba(239,68,68,0.5)] transition duration-300"
                    title="Stop Tracking"
                  >
                    ✕
                  </button>
