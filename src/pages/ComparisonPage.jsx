...
const ProfileCard = ({ data, onRemove }) => (
  <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 text-center relative group flex flex-col items-center">
    ...
    <a 
      ...
      target="_blank" 
      rel="noreferrer" 
      className="w-full max-w-50 py-2 bg-gray-800 text-xs font-bold rounded-lg text-white hover:bg-gray-700 transition border border-gray-700 flex items-center justify-center gap-2"
    >
